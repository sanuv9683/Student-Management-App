...
<!--        <div class="page-loader-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form id="form_validation" class="coursebathform" method="POST">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <p>
                                                <b>Select Batch</b>
                                            </p>
                                            <select class="form-control show-tick" name="batch"  data-live-search="true" id="batch-cmb">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <select class="form-control show-tick" name="course" data-live-search="true" id="crs-cmb">
                                                <!--//multiple-->
                                    ...
                                    <button class="btn btn-primary waves-effect" id="bcmerge-btn" type="button">SUBMIT COURSE FOR BATCH</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Available Courses For <span id="spid"></span></h2>
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                            <i class="material-icons">more_vert</i>
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="course-etb">
                                        <thead class="bg-pink">
                                            <tr>
                                                <th>Course Code</th>
                                                <th>Course Name</th>
        ...
        <link href="resources/plugins/bootstrap-select/css/bootstrap-select.css" rel="stylesheet" />
        <script src="resources/js/ajax/sanu-ajax-cobat.js"></script>
    </body>
